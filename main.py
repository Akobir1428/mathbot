...
RENDER_URL = "https://mathbot-uame.onrender.com/" # Ssilka oxirida / bo'lishi shart
...
# --- BAZA BILAN ISHLASH (Yaxshilangan ulanish va tezlik) ---
def get_db_connection():
    # timeout=20 bazani qotib qolishdan (lock) himoya qiladi
...
def fetch_query(query, params=(), fetchone=False):
    try:
        with get_db_connection() as conn:
            ...
            if fetchone:
                res = cursor.fetchone()
                # Agar ma'lumot topilsa list qilib qaytaradi, avvalgi kod bilan mos ishlashi uchun
...
# --- WEBHOOK YO'LAKLARI (Tezlashtirilgan qabul) ---
